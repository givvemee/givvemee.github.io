...
//         <div style={{margin: 20}}>
//             <p>
//                 <input type="text" onChange={changeInput1} name="userid" value={userid} ref={idRef}/>
//                 <input type="text" onChange={changeInput2} name="userpw" value={userpw}/>
//                 <input type="text" onChange={changeInput3} name="usermail" value={usermail}/>
//                 <button onClick={onReset}>Reset</button>
//             </p>
//             <hr/>
//             <h4>ID: {userid}</h4>
